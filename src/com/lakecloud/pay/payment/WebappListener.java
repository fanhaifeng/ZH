 ...
 * </pre>
 */
package com.lakecloud.pay.payment;
...
public class WebappListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent servletContextEvent) {
		head();
		try {
			String systemConfigPath = servletContextEvent.getServletContext()
					.getInitParameter("system.config.path");
			String paymentConfigPath = servletContextEvent.getServletContext()
					.getInitParameter("payment.config.path");
			// Log4j
