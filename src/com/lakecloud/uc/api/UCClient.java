...
/**
 * Discuz! Ucenter API for 江苏太湖云计算信息技术股份有限公司,UC Client 通用调用该类来实现与UC Server之间的通信。 该类实现与UC
...
public class UCClient extends PHPFunctions {
	...
	public static String UC_KEY = "123456";// 江苏太湖云计算信息技术股份有限公司应用的KEY
	public static String UC_APPID = "2";// 江苏太湖云计算信息技术股份有限公司应用的ID
