...
public class Globals {
	...
	public final static String DEFAULT_SHOP_OUT_VERSION = "V1.5";// 软件大版本号
	...
	public final static String UPLOAD_FILE_PATH = File.separator+"upload";// 默认文件上传路径
	...
	public final static String DEFAULT_PAGE_SIZE = "20";//搜索默认数据长度
