...
public class StoreViewTools {
	 ...
	 * @return
	 */
	public List<Store> query_recommend_store(int count, String pc_city_id) {
		...
		if (!"all".equals(pc_city_id) && !"-1".equals(pc_city_id)) {
			hql = " and obj.area.parent.id=:pc_city_id ";
			params.put("pc_city_id", Long.parseLong(pc_city_id));
		}
		list = this.storeService.query(
				"select obj from Store obj where obj.store_recommend=:recommend"
