...
public class JobManageAction {
	...
	public void execute() {
		...
		for (Goods goods : goods_list) {
			...
			vo.setVo_goods_price(goods.getGoods_price());
			vo.setVo_goods_serial(goods.getGoods_serial());
			vo.setVo_goods_store(goods.getGoods_store()==null?"":goods.getGoods_store().getStore_name());
			...
			vo.setVo_goods_current_price(goods.getGoods_current_price());
